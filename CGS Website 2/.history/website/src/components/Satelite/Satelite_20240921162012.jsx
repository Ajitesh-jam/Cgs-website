...
const Satellite = () => {
  return (
    <>
      <section className="bg-gradient-to-r from-black to-black-400 to-black-500 text-white py-20 rounded-2xl border" id="satellite">
...
>
  <source src={featuredGame} type="video/mp4" />
      ...
      <section className="bg-gradient-to-r from-black to-black black-400 to-black-500 text-white py-20 rounded-2xl border" id="satellite">
        <div className="container ">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
            <div className="space-y-3 xl:pr-36 p-4 border-l-2 border-b-2 border-l-white-800 border-b-white-800 rounded-2xl ">
              <p
