...
const GameDev = () => {
  ...
  const actionGames = [
    { id: 1, name: 'Game 1', image: game1   ,creator:'Ajitesh'},
    { id: 2, name: 'Game 2', image: game1   ,creator:'Ajitesh'},
    { id: 3, name: 'Game 3', image: game1   ,creator:'Ajitesh'},
    { id: 4, name: 'Game 4', image: game1   ,creator:'Ajitesh'},
    { id: 5, name: 'Game 5', image: game1   ,creator:'Ajitesh'},
  ];  
  const storyGames = [ 
    { id: 6, name: 'Game 6', image: game1   ,creator:'Ajitesh'},
    { id: 7, name: 'Game 7', image: game1   ,creator:'Ajitesh'},
    { id: 8, name: 'Game 8', image: game1   ,creator:'Ajitesh'},
    { id: 9, name: 'Game 9', image: game1   ,creator:'Ajitesh'},
    { id: 10, name: 'Game 10', image: game1 ,creator:'Ajitesh'},
  ];
  const puzzleGames = [
    { id: 11, name: 'Game 11', image: game1 ,creator:'Ajitesh'},
    { id: 12, name: 'Game 12', image: game1 ,creator:'Ajitesh'},
    { id: 13, name: 'Game 13', image: game1 ,creator:'Ajitesh'},
    { id: 14, name: 'Game 14', image: game1 ,creator:'Ajitesh'},
    { id: 15, name: 'Game 15', image: game1 ,creator:'Ajitesh'},
  ];
              ...
              <div className="card" key={game.id} data-aos="zoom-in">
                <div className="card-inner">
                  ...
                  <div className="card-back">
                    <h2>{game.name}<br>Made by {game.creator}</br></h2>
