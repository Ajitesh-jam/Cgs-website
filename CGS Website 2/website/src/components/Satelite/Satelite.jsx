...
const Satellite = () => {
  return (
    <>
      <section className="bg-black text-white py-20" id="satellite">
        <div className="container ">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
            <div className="space-y-3 xl:pr-36 p-4 rounded-2xl ">
              ...
              <p data-aos="fade-up" className="text-lg m-1" data-aos-delay="700">
        ...
        <div className="container ">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
            <div className="space-y-3 xl:pr-36 p-4 rounded-2xl ">
              ...
              <p data-aos="fade-up" data-aos-delay="700" className="text-lg m-1">
