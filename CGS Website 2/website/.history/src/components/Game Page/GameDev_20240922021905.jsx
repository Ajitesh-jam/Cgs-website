...
const GameDev = () => {
  const [currentGame, setCurrentGame] = useState(0);
  const [selectedGame, setSelectedGame] = useState({ id: 1, name: 'Game 1', image: game1, creator: 'Ajitesh', linkedin: 'https://www.linkedin.com/in/ajitesh-jamulkar-2a5351260/' }); // State to track selected game for popup
  const [isPopupVisible, setIsPopupVisible] = useState(true); // State to track popup visibility
