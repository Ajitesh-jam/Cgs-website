        ...
        <div className="Our-Services" id="Our-Services">
            <div className="container">
                ...
                <div className="services">
                    <ServiceBox icon="fa-solid fa-credit-card fa-fw" title="Online Purchasing" description="Buy your favorite games directly from our website." />
...
function ServiceBox({ icon, title, description }) {
    return (
        <div className="box">
            <div className="icon aos-init aos-animate" data-aos-duration="1100" data-aos="fade-up"><i className={icon}>bubfjefb</i></div>
