        ...
        <div className="landing-page">
            <div className="intro">
                ...
                <ul className="platforms">
                    <li><a href="pc.html" title="PC"><i className="fa-solid fa-desktop fa-fw"></i>PC</a></li>
                    <li><a href="playstation.html" title="Playstation"><i className="fa-brands fa-playstation fa-fw"></i>Playstation</a></li>
                    <li><a href="xbox.html" title="Xbox"><i className="fa-brands fa-xbox fa-fw"></i>Xbox</a></li>
                </ul>
            </div>
